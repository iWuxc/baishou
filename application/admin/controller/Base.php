...
class Base extends Controller {
    ...
    { 
        //过滤不需要登陆的行为
        if(in_array(ACTION_NAME,array('login','logout','vertify','getRegion','check_nowrate','startCaptchaServlet'))){
        	//return;
        }else{
    ...
    public function check_priv()
    {
		...
		//无需验证的操作
		$uneed_check = array('login','logout','vertifyHandle','vertify','imageUp','upload','login_task','getRegion','check_nowrate');
