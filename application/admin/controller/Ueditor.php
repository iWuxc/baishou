	...
	*/
    ...
    public function imageUp()
    {
		...
		$result = $this->validate(
				['file' => $file],
				//['file'=>'image|fileSize:40000000|fileExt:jpg,jpeg,gif,png,pdf'],
                //设置类型后无法上传PDF格式
				['file'=>'fileSize:40000000|fileExt:jpg,jpeg,gif,png,pdf'],
				['file.image' => '上传文件必须为图片','file.fileSize' => '上传文件过大','file.fileExt'=>'上传文件后缀名必须为jpg,jpeg,gif,png,pdf']
		);
        if (true !== $result || !$file) {
            $state = "ERROR" . $result;
        } else {
